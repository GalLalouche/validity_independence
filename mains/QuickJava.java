...
public class QuickJava extends ApplicationFrame
{

    public QuickJava(String s)
    {
        super(s);
        /** //*/
    ...
    {
        QuickJava xylineandshaperendererdemo2 = new QuickJava("JFreeChart: XYLineAndShapeRendererDemo2");
